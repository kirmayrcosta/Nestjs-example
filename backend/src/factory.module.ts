...
export class FactoryModule {
  ...
  static CONVERTER_CURRENCY_TO_PRICE_USE_CASE =
    'ConverterCurrencyToPriceUseCase';
  ...
  static UPDATE_QUOTATION_TO_CURRENCY_USE_CASE =
    'UpdateQuotationToCurrencyUseCase';
  static REMOVE_QUOTATION_TO_CURRENCY_USE_CASE =
    ...
    return {
      ...
      providers: [
        ...
        },
        {
          ...
          useFactory: (currencyRepository: CurrencyRepository) =>
            new GetAllCurrencyUseCase(currencyRepository),
        },
        {
          inject: [CurrencyRepository],
          provide: FactoryModule.CONVERTER_CURRENCY_TO_PRICE_USE_CASE,
          useFactory: (currencyRepository: CurrencyRepository) =>
            new ConverterCurrencyToPriceUseCase(currencyRepository),
        },
        {
          inject: [CurrencyRepository],
          provide: FactoryModule.GET_CURRENCY_USE_CASE,
          useFactory: (currencyRepository: CurrencyRepository) =>
            new GetCurrencyUseCase(currencyRepository),
        },
        {
          inject: [CurrencyRepository],
          provide: FactoryModule.UPDATE_CURRENCY_USE_CASE,
          useFactory: (currencyRepository: CurrencyRepository) =>
            new UpdateCurrecyUseCase(currencyRepository),
        },
        {
          inject: [CurrencyRepository],
          provide: FactoryModule.DELETE_CURRENCY_USE_CASE,
          useFactory: (currencyRepository: CurrencyRepository) =>
            new DeleteCurrencyUseCase(currencyRepository),
        },
        {
          inject: [CurrencyRepository],
          provide: FactoryModule.REMOVE_QUOTATION_TO_CURRENCY_USE_CASE,
          useFactory: (currencyRepository: CurrencyRepository) =>
            new RemoveQuoteToCurrencyUsecase(currencyRepository),
        },
        {
          inject: [CurrencyRepository],
          provide: FactoryModule.ADD_QUOTATION_TO_CURRENCY_USE_CASE,
          useFactory: (currencyRepository: CurrencyRepository) =>
            new AddQuoteToCurrencyUseCase(currencyRepository),
        },
        {
          inject: [CurrencyRepository],
          provide: FactoryModule.UPDATE_QUOTATION_TO_CURRENCY_USE_CASE,
          useFactory: (currencyRepository: CurrencyRepository) =>
            new UpdateQuoteToCurrencyUsecase(currencyRepository),
        },
      ],
      exports: [
